...
public class NumberParser {
    ...
    /**
     * Fuehrt eine Kontrolle auf zahlen mit unlogisch vielen Nachkommastellen durch.
     * 
     * @param betrag Summe als double
     * @throws ZuVieleNachkommastellenException Exception bei Zahlen mit zu vielen Nachkommastellen
     */
    private void checkNumber(final double betrag) throws ZuVieleNachkommastellenException {

        final long l = (long) (betrag * 100.0);

        if (l != betrag * 100) {
            throw new ZuVieleNachkommastellenException("Anzahl Nachkommastellen: ");
        }
    }
}
